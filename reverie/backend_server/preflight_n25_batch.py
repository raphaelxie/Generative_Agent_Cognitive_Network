#!/usr/bin/env python3
"""
Run n=25 pre-flight measurement batch after burn-in:
  survey pre + hub/broker shock probe (no post wave).

Usage (from reverie/backend_server/, after burn-in):
  python preflight_n25_batch.py

Requires:
  environment/frontend_server/storage/preflight_the_ville_n25-1
"""
import os
import sys
